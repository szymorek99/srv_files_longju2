...
teleport_area:
	...
	void RegisterPCFunctionTable()
	{
		luaL_reg pc_functions[] =
		{
			...
			{ "get_exp_level_pct",		pc_get_exp_level0	},	
			
			{ "set_max_health",		pc_set_max_health	},	
			{ "get_ip0",			pc_get_ip0			},	
			{ "get_ip",				pc_get_ip0			},	
			{ "get_client_version0",pc_get_client_version0	},	
			{ "get_client_version",	pc_get_client_version0	},	
			{ "dc_delayed0",		pc_dc_delayed0	},	
			{ "dc_delayed",			pc_dc_delayed0	},	
			{ "dc_direct0",			pc_dc_direct0	},	
			{ "dc_direct",			pc_dc_direct0	},	
			{ "is_trade0",			pc_is_trade0	},	
			{ "is_trade",			pc_is_trade0	},	
			{ "is_busy0",			pc_is_busy0		},	
			{ "is_busy",			pc_is_busy0		},	
			{ "is_arena0",			pc_is_arena0		},	
			{ "is_arena",			pc_is_arena0		},	
			{ "is_arena_observer0",	pc_is_arena_observer0		},	
			{ "is_arena_observer",	pc_is_arena_observer0		},	
			
			{ "equip_slot0",		pc_equip_slot0		},	
			{ "equip_slot",			pc_equip_slot0		},	
			
			{ "unequip_slot0",		pc_unequip_slot0	},	
			{ "unequip_slot",		pc_unequip_slot0	},	
			{ "is_available0",		pc_is_available0	},	
			{ "is_available",		pc_is_available0	},	
			{ "give_random_book0",	pc_give_random_book0},	
			{ "give_random_book",	pc_give_random_book0},	
			{ "is_pvp0",			pc_is_pvp0			},	
			{ "is_pvp",				pc_is_pvp0			},	
			...
			{ "open_shop",			pc_open_shop0		},	
#endif
#ifdef ENABLE_NEWGUILDMAKE
			
			{ "make_guild0",			pc_make_guild0	},	
			{ "make_guild",				pc_make_guild0	},	
#endif
#ifdef ENABLE_ACCE_COSTUME_SYSTEM
