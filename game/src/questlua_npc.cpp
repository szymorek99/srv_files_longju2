...
namespace quest
{
	...
	void RegisterNPCFunctionTable()
	{
		luaL_reg npc_functions[] =
		{
			...
			{ "get_name",			npc_get_name0},		
			{ "get_pid0",			npc_get_pid0},		
			{ "get_pid",			npc_get_pid0},		
			{ "get_vnum0",			npc_get_vnum0},		
			{ "get_vnum",			npc_get_vnum0},		
			{ "get_type0",			npc_get_type0},		
			{ "get_type",			npc_get_type0},		
			{ "is_available0",		npc_is_available0},	
			{ "is_available",		npc_is_available0},	
			{ "select_vid0",		npc_select_vid0},	
			{ "select_vid",			npc_select_vid0},	
			{ "talk",				npc_talk},			
#endif
			{ NULL,				NULL			    	}
		};
