...
#define NS_ITEM_GETMODE0(x)	\
	...
	void RegisterITEMFunctionTable()
	{
		...
		luaL_reg item_functions[] =
		{
			...
			{ "get_wearflag",			item_get_wearflag0},	
			{ "has_wearflag0",			item_has_wearflag0},	
			{ "has_wearflag",			item_has_wearflag0},	
			{ "get_antiflag0",			item_get_antiflag0},	
			{ "get_antiflag",			item_get_antiflag0},	
			{ "has_antiflag0",			item_has_antiflag0},	
			{ "has_antiflag",			item_has_antiflag0},	
			{ "get_immuneflag0",		item_get_immuneflag0},	
			{ "get_immuneflag",			item_get_immuneflag0},	
			{ "has_immuneflag0",		item_has_immuneflag0},	
			{ "has_immuneflag",			item_has_immuneflag0},	
			...
			{ "add_attr",			item_add_attr0}, 
			
			{ "change_attr0",		item_change_attr0},
			{ "change_attr",		item_change_attr0}, 
			
			{ "clear_attr0",		item_clear_attr0},
			{ "clear_attr",			item_clear_attr0}, 
			
			{ "count_attr0",		item_count_attr0},
			{ "count_attr",			item_count_attr0}, 
			
			{ "get_attr0",			item_get_attr0},	
			{ "get_attr",			item_get_attr0},	
			
			{ "set_attr0",			item_set_attr0},	
			{ "set_attr",			item_set_attr0},	
			...
			{ "is_available",		item_is_available0	},	
#endif
			{ NULL,			NULL			}
		};
